...
import {JOB_INSTANCE_TASK_APIS} from "/@/api/serverApis";
...
export function useInstanceTaskApi() {
  return {
    ...
    getListChildList: (params?: object) => {
      return request({
        url: JOB_INSTANCE_TASK_APIS.listChild,
        method: 'get',
        params,
      });
    },
    stop: (data: object) => {
      return request({
        url: JOB_INSTANCE_TASK_APIS.stopTask,
        method: 'post',
        data,
      });
    },
