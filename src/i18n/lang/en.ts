...
export default {
  ...
  crontab: {
    index: {
      ...
      hourTimeUnit: 'Hour',
      dayOfMonthTimeUnit: 'Day',
      monthTimeUnit: 'Month',
      dayOfWeekTimeUnit: 'Week',
      yearTimeUnit: 'Year',
    ...
    second: {
      eachSecond: ' second, allowed wildcards[, - * /] ',
      periodStart: 'period start',
      from: 'start',
      secondsStartEvery: ' second start, every ',
      executeOncePerSecond: 'execute once per second',
      assign: 'designation',
    },
    minute: {
      minutesAllowedWildcard: ' minute, allowed wildcards[, - * /] ',
      periodStart: 'period start',
      from: 'start',
      minuteStartEvery: 'minute start, every ',
      executeOncePerMinute: 'execute once per minute',
      assign: 'designation',
    },
    hour: {
      hourAllowedWildcards: ' hour, allowed wildcards[, - * /] ',
      periodStart: 'period start',
      from: 'start',
      hourStartEvery: 'hour start, every ',
      executeOncePerHour: 'per hour exection',
      assign: 'designation',
    },
    day: {
      dayAllowedWildcard: ' day, allowed wildcards[, - * ? / L W] ',
      notSpecify: ' not designation ',
      periodStart: 'period start',
      from: 'start',
      theNumberStartsEvery: 'day start, every ',
      dailyExecution: 'per day exection',
      eachMonth: 'monthly',
      theMostRecentBusinessDay: 'most recent business day',
      lastDayOfTheMonth: 'last day of month',
      assign: 'designation',
    },
    month: {
      monthAllowedWildcards: ' month, allowed wildcards[, - * /] ',
      periodStart: 'period start',
      from: 'start',
      monthStartEvery: ' month start, every ',
      executeOncePerMonth: 'per month exection',
      assign: 'designation', 
    },
    week: {
      weekAllowedWildcards: ' week, allowed wildcards[, - * ? / L #] ',
      notSpecify: ' not designation ',
      periodStart: 'period start',
      serial: 'the',
      periclinal: 'week',
      lastOfTheMonth: 'last of the month',
      assign: 'designation',
      monday: 'monday',
      tuesday: 'tuesday',
      wednesday: 'wednesday',
    ...
    result: {
      last5RunningTimes: 'Last five running time',
