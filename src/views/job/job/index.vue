...
const getTableData = async () => {
  ...
  data.list.forEach(function (item: Object) {
    state.tableData.data.push({
      ...
      shellProcessorType: item['shellProcessorType'],
      shellProcessorInfo: item['shellProcessorInfo'],
      kettleProcessorType: item['kettleProcessorType'],
      kettleProcessorInfo: item['kettleProcessorInfo'],
      shardingParams: item['shardingParams'],
